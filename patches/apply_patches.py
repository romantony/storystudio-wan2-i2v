...
def apply_flashattention_patches(wan_dir="/workspace/Wan2.2"):
    ...
    Phase 2: Alias flash_attention to attention() in model files
...
'''
    ...
    candidates = [
        ...
        wan_path / "wan/i2v/model_i2v.py",
        wan_path / "wan/tasks/i2v/model_i2v.py",
        wan_path / "wan/models/i2v.py",
    ]
    ...
    if not patched_any:
        print("No known model paths found, scanning repository for imports...")
